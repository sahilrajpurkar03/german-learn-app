...
2. Create/use a Groq **Free** project. Do not upgrade to Developer or configure paid fallback. Verify model availability and actual organization quotas. Enable Zero Data Retention in Groq Data Controls, and review the processing agreement and international transfers before using personal data.
