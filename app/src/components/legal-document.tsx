    ...
    <main className="legal-page">
      <article>
        ...
        {page === "privacy" && <>
          ...
          <p>Learning estimates are informal and do not make legally significant automated decisions about you. Features and these notices may change. A visible beta notice is shown throughout the app; it is a status notice, not consent to data sharing or a waiver of your rights.</p>
        </>}
